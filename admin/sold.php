          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <form method="post" action="exportsold.php">
                  ...
                  <tbody>
                     <?php
                      while($row=$result->fetch_assoc())
                      {
                        ...
                        echo'<td><a herf="../seller/assets/auction/'.$row['image'].'" target="_blank"><img src="../seller/assets/auction/'.$row['image'].'" class="img-thumbnail"></a></td>';
